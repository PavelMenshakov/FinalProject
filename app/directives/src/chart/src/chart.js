...
var dn = namespace('ajsApp.directives.chart');
dn.$module = angular.module('ajsApp.directives.chart',[
    'ngAnimate'
]).directive('customChart', function ($window) {
    ...
    return {
        ...
        templateUrl: 'app/directives/src/chart/src/tpl/chart.tpl.html'
    };
});